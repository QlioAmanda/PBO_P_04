...
public class Main {
    public static void main(String[] args) {
        try (Scanner sc = new Scanner(System.in)) {
            ...
            System.out.println("Pilih Jenjang: ");
            System.out.println("1. Sarjana (S1)");
            System.out.println("2. Diploma (D3)");
            System.out.print("Masukkan pilihan jenjang: ");
            int jenis = sc.nextInt();
            sc.nextLine();

            Mahasiswa mhs;
            if (jenis == 1) {
                mhs = new MahasiswaSarjana(nama, nim, jurusanDipilih);
            } else {
                mhs = new MahasiswaDiploma(nama, nim, jurusanDipilih);
            }

            // Tampilkan hasil
            System.out.println("\n=== Data Mahasiswa ===");
            System.out.println(mhs); // polymorphic toString()
